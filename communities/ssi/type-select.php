                    ...
                    <table class="table table-hover type-table">
                        ...
                        foreach ($results as $data) {
                            ...
                            if ($data->url)
                                ...
                                echo '<h3><a href="/' . $community->portalName . '/about/resource?form=' . $data->name . '&rel=' . $relArray[$data->id] . '">' . $data->name . '</a></h3>';
                        ...
                        <tr class="last">
                            <td>
                                <h3><a href="/create/resource?form=resource">For all other resource types, e.g., software tools, services</a></h3>
