        ...
        <div class="col-sm-4 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/components/header"><i class="fa fa-cog pull-right"></i></a>
                </div>
        ...
        <div class="col-sm-4 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/components/body"><i class="fa fa-cog pull-right"></i></a>
                </div>
                            ...
                            <div class="overflow-h" style="display: block">
                                <h3 class="heading-xs"><?php echo $component->getName() ?>
                                    ...
                                    if($component->getDynamicStatus()){
                                        echo '<a href="'.$profileBase.'account/scicrunch/dynamic/'.$component->component.'" class="pull-right"><i class="fa fa-file-text-o"></i></a>';
                                    }
                                    ?>
                                </h3>
                            </div>
        ...
        <div class="col-sm-4 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/components/footer"><i class="fa fa-cog pull-right"></i></a>
                </div>
