<div class="tab-pane fade <?php if ($section == 'content') echo 'in active' ?>" id="content">
    ...
    foreach ($components['page'] as $container) {
        ...
        echo '<li><a href="'.$profileBase.'account/scicrunch/component/insert/' . $container->component . '"><i class="fa fa-plus-circle"></i> Add Content</a></li>';
        if($container->position>0)
            echo '<li><a href="/forms/component-forms/container-component-shift.php?component='.$container->id.'&cid=0&direction=up"><i class="fa fa-angle-up"></i> Move Up</a></li>';
        elseif($container->position<count($components['page'])-1)
            echo '<li><a href="/forms/component-forms/container-component-shift.php?component='.$container->id.'&cid=0&direction=down"><i class="fa fa-angle-down"></i> Move Down</a></li>';
        ...
        echo '<li><a href="/forms/component-forms/container-component-delete.php?cid=0&id=' . $container->id . '"><i class="fa fa-times"></i> Delete</a></li>
                                        </ul>
                                    </div>';
        echo '</div>';
        ...
        $datas = $holder->getByComponentNewest($container->component, 0, 0, 10);
        ...
        echo '</div>';
        echo '<a href="'.$profileBase.'account/scicrunch/view/'.$container->component.'" class="btn-u btn-u-dark" style="width:100%;text-align: center;margin-top: 10px;">SEE ALL</a>';
        echo '</div></div>';
        if ($start) {
            $start = false;
        } else {
        ...
        foreach ($static as $data) {
            ...
            echo '<div class="btn-group pull-right" style="margin-top:-4px;">
                                    ...
                                    Action
                                        ...
                                        <ul class="dropdown-menu" role="menu">';
            echo '<li><a href="javascript:void(0)" class="edit-container" container="'.$container->id.'" community="'.$community->id.'"><i class="fa fa-wrench"></i> Edit Container</a></li>';
            echo '<li><a href="/forms/component-forms/container-component-delete.php?cid=0&id=' . $data->id . '"><i class="fa fa-times"></i> Delete</a></li>
                                        </ul>
                                    </div>';
            echo '<div class="overflow-h" style="display: inline-block">';
        ...
        <div class="col-sm-6 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/component/insert/104"><i class="fa fa-plus-circle pull-right"></i></a>
                </div>
                ...
                <a href="<?php echo $profileBase?>account/scicrunch/view/104" class="btn-u btn-u-dark" style="width:100%;text-align: center;margin-top: 10px;">SEE ALL</a>
            </div>
        </div>
        ...
        <div class="col-sm-6 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/component/insert/105"><i class="fa fa-plus-circle pull-right"></i></a>
                </div>
                <div id="scrollbar2" class="panel-body contentHolder">
                    <?php
                ...
                <a href="<?php echo $profileBase?>account/scicrunch/view/105" class="btn-u btn-u-dark" style="width:100%;text-align: center;margin-top: 10px;">SEE ALL</a>
            </div>
        </div>
    </div>
</div>
...
<div class="cont-select-container back-hide">
    ...
    <div class="selection">
        ...
        <div class="components-select">
            ...
            echo $holder->getContainerSelectHTML(0);
            ?>
        </div>
    </div>
</div>
