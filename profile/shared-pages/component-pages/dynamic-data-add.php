...
<div class="profile container content">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form method="post" action="/forms/community-forms/dynamic-insert.php?id=<?php echo $component_id?>&cid=<?php echo $community->id?>" id="header-component-form" class="sky-form" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <section>
                            ...
                            <label class="input">
                                ...
                                <input type="text" name="title" placeholder="Focus to view the tooltip">
                        ...
                        <section>
                            ...
                            <label class="input">
                                <i class="icon-append fa fa-question-circle"></i>
                                <input type="text" name="tags" class="" placeholder="Focus to view the tooltip" value="">
                        ...
                        <section>
                            ...
                            <textarea rows="3" placeholder="Focus to view the tooltip" class="summer-text" name="description"></textarea>

                        </section>
                        <section>
                            <label class="label">Content</label>

                            <textarea rows="3" placeholder="Focus to view the tooltip" class="summer-text" name="content"></textarea>
