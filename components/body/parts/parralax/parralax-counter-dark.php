...
?>
<div class="parallax-counter-v1 parallaxBg <?php if($vars['editmode']) echo 'editmode' ?>">
    <div class="container">
        <h2 class="title-v2 title-light title-center"><?php echo $component->text1?></h2>
        <p class="space-xlg-hor text-center color-light"><?php echo $component->text2?></p>
